...
export const games: readonly Game[] = [
  {
    ...
    price: 'Free',
    shortDescription:
      'Cozy Italian Vacation Cafe \u{1F3D6}\u{FE0F} No timers, No stress \u{1F60C} cook traditional dishes \u{1F35D} upgrade and customize \u{1F3E0} just drink Prosecco \u{1F942} relax and grow your dream cafe ✨',
    rating: 4.8,
    likesCount: 28_750,
